...
import com.api.pagamento.exception.CartaoInvalidoException;
...
public class CartaoServicoImplTest {
	...
	CartaoCredito cartaoMastesCard = new CartaoCredito("Wesley Jr", "5446972973560379", LocalDate.now().plusYears(3),"737");

	CartaoCredito cartaoVisa = new CartaoCredito("Wesley Jr", "4485265266556559", LocalDate.of(2019, 10, 31), "182");

	CartaoCredito cartaoAmericanExpress = new CartaoCredito("Wesley Jr", "378856551391153",
			LocalDate.of(2019, 05, 31), "236");

	CartaoCredito cartaoAExpress2 = new CartaoCredito("Wesley Jr", "341119817440437", LocalDate.of(2019, 05, 31),
			"236");

	CartaoCredito cartaoElo = new CartaoCredito("Wesley Jr", "4011045499285470", LocalDate.of(2020, 01, 31), "573");

	CartaoCredito cartaoHipercard = new CartaoCredito("Wesley Jr", "6062825854058643", LocalDate.of(2030, 01, 31),
			"784");

	CartaoCredito cartaoSemBandeira = new CartaoCredito("Wesley Jr", "201419312362501", LocalDate.of(2020, 01, 21),
			"347");
	...
	public void validarCartaoComFalhaNumero() {
		CartaoCredito numeroErrado = new CartaoCredito("Sandy", "1112222222222222", LocalDate.of(2020, 01, 21), "123");
		try {
	...
	public void validarCartaoComFalhaData() {
		CartaoCredito dataErrada = new CartaoCredito("Sandy", "4485265266556559", LocalDate.of(2010, 01, 21), "123");
		cartaoServico.validarCartao(dataErrada);
	}

	@Test
	public void validarCartaoComFalhaCvv() {
		CartaoCredito cvvErrado = new CartaoCredito("Sandy", "4485265266556559", LocalDate.of(2010, 01, 21), "3123");
		try {
